...
const programs = [
  ...
  },
  {
    ...
    purpose:
      "Supports children and youth facing educational, behavioral, emotional, or social challenges through corrective education, therapeutic interventions, and life skills development.",
    groups: [
      { heading: "Educational Services", items: ["Alternative Education", "Remedial Learning", "Psycho-Education", "Therapeutic Boarding School Programs"] },
      { heading: "Therapeutic Services", items: ["Individual Therapy", "Group Counselling", "Art Therapy Workshops", "Occupational Therapy", "Spiritual Recovery", "Wilderness Therapy"] },
      { heading: "Health & Wellness Services", items: ["Nutrition and Body Exercise", "Sports and Recreation", "Music Enrichment Programs"] },
      { heading: "Recovery Programs", items: ["Residential Treatment", "Residential Facilities", "Boot Camp Programs", "The 12 Steps of Alcoholics Anonymous (AA)"] },
    ],
    outcomes: [
  ...
  },
  {
    ...
    purpose:
      "Helps children safely reunite with their families and communities while strengthening relationships and support systems.",
    groups: [
      { heading: "Services Offered", items: ["Family Therapy", "Family Support Programs", "Positive Parenting Training", "Family Mediation", "Child Reintegration Services", "Community Outreach"] },
    ],
    outcomes: [
  ...
  },
  {
    ...
    purpose:
      "Provides continued guidance, mentorship, and support after completing RELI programs, ensuring long-term success.",
    groups: [
      { heading: "Services Offered", items: ["Aftercare Programs", "Mentorship", "Career Guidance", "School Re-enrollment Monitoring", "Life Coaching", "Alumni Support Network"] },
    ],
    outcomes: [
      ...
      <Section className="space-y-16">
            ...
            >
              <div className="flex items-center gap-4 bg-gradient-hero p-6 text-primary-foreground md:p-8">
                <motion.div
                  ...
                  className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-primary-foreground/20"
                >
        ...
        <Reveal>
          <motion.div
            ...
            className="rounded-3xl bg-gradient-soft p-8 text-center md:p-12"
          >
